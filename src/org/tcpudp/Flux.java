...
public class Flux {
    ...
    protected Flux(java.net.Socket socket) {
        try {
            ...
            throw new org.tcpudp.FluxStreamException("Error initializing OutputStream");
        }
        ...
        try {
            ...
            throw new org.tcpudp.FluxStreamException("Error initializing InputStream");
        }
    }
    ...
    protected void send(Object obj) {
        if(encrypt){
            try {
                ...
                throw new org.tcpudp.SendingException("Error sending trame");
            } catch (Exception ex) {
                throw new org.tcpudp.SendingException("Encrypt trame is impossible");
            }
        }else{
            try {
    ...
    protected Object receive() {
        if(encrypt){
            try {
                ...
                throw new org.tcpudp.ReceivingIOException(ex.getMessage(), ex.getCause());
            } catch (ClassNotFoundException ex) {
                throw new org.tcpudp.ReceivingClassNotFoundException("Error reading to Trame");
            } catch(java.lang.ClassCastException ex){
                throw new org.tcpudp.ReceivingClassNotFoundException("Error ClassCastException");
            } catch (Exception ex) {
                throw new org.tcpudp.SendingException("Decrypt trame is impossible");
            }
        }else{
            try {
